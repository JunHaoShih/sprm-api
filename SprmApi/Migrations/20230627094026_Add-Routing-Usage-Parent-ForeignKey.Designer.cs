            ...
            modelBuilder.Entity("SprmApi.Core.MakeTypes.MakeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1218),
                            CreateUser = "system",
                            ...
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1222),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1226),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "外包",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1226),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ObjectTypes.ObjectType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1273),
                            CreateUser = "system",
                            Name = "料件",
                            Number = "PartVersion",
                            Remarks = "料件",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1274),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1277),
                            CreateUser = "system",
                            Name = "料件使用關係",
                            Number = "PartUsage",
                            Remarks = "料件使用關係",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1277),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1279),
                            CreateUser = "system",
                            Name = "產品途程",
                            Number = "Routing",
                            Remarks = "產品途程",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1279),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1280),
                            CreateUser = "system",
                            Name = "產品途程版本",
                            Number = "RoutingVersion",
                            Remarks = "產品途程版本",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1280),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 5L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1281),
                            CreateUser = "system",
                            Name = "製程",
                            Number = "Process",
                            Remarks = "製程",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1282),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 6L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1285),
                            CreateUser = "system",
                            Name = "途程之製程",
                            Number = "RoutingProcess",
                            Remarks = "途程之製程",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1285),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ProcessTypes.ProcessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1250),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "加工製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1250),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1253),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "檢驗製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1253),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1254),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "組裝製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1254),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1255),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "運輸製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 27, 9, 40, 26, 14, DateTimeKind.Utc).AddTicks(1256),
                            UpdateUser = "system"
                        });
                });
