            ...
            modelBuilder.Entity("SprmApi.Core.ObjectTypes.ObjectType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3705),
                            CreateUser = "system",
                            Name = "料件",
                            Number = "PartVersion",
                            Remarks = "料件",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3705),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3709),
                            CreateUser = "system",
                            Name = "料件使用關係",
                            Number = "PartUsage",
                            Remarks = "料件使用關係",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3710),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3711),
                            CreateUser = "system",
                            Name = "產品途程",
                            Number = "Routing",
                            Remarks = "產品途程",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3711),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3712),
                            CreateUser = "system",
                            Name = "產品途程版本",
                            Number = "RoutingVersion",
                            Remarks = "產品途程版本",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3712),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 5L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3714),
                            CreateUser = "system",
                            Name = "製程",
                            Number = "Process",
                            Remarks = "製程",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3714),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 6L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3716),
                            CreateUser = "system",
                            Name = "途程之製程",
                            Number = "RoutingProcess",
                            Remarks = "途程之製程",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3716),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.Processes.MakeTypes.MakeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3662),
                            CreateUser = "system",
                            ...
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3664),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3668),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "外包",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3668),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.Processes.ProcessTypes.ProcessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3687),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "加工製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3687),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3689),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "檢驗製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3689),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3690),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "組裝製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3690),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3691),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "運輸製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 8, 22, 32, 914, DateTimeKind.Utc).AddTicks(3691),
                            UpdateUser = "system"
                        });
                });
