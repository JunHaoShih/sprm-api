...
namespace SprmApi.Migrations
{
    ...
    [Migration("20230630021720_Change-Object-Type-Name")]
    partial class ChangeObjectTypeName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SprmApi.Core.MakeTypes.MakeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8544),
                            CreateUser = "system",
                            ...
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8546),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8549),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "外包",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8549),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ObjectTypes.ObjectType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8593),
                            CreateUser = "system",
                            Name = "料件",
                            Number = "PartVersion",
                            Remarks = "料件",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8593),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8596),
                            CreateUser = "system",
                            Name = "料件使用關係",
                            Number = "PartUsage",
                            Remarks = "料件使用關係",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8597),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8598),
                            CreateUser = "system",
                            Name = "工藝路徑",
                            Number = "Routing",
                            Remarks = "工藝路徑",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8598),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8599),
                            CreateUser = "system",
                            Name = "工藝路徑版本",
                            Number = "RoutingVersion",
                            Remarks = "工藝路徑版本",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8599),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 5L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8603),
                            CreateUser = "system",
                            Name = "製程",
                            Number = "Process",
                            Remarks = "製程",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8603),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 6L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8605),
                            CreateUser = "system",
                            Name = "工藝路徑使用關係",
                            Number = "RoutingProcess",
                            Remarks = "工藝路徑使用關係",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8605),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ProcessTypes.ProcessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8571),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "加工製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8571),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8573),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "檢驗製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8574),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8574),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "組裝製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8575),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8575),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "運輸製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 30, 2, 17, 20, 2, DateTimeKind.Utc).AddTicks(8576),
                            UpdateUser = "system"
                        });
                });
