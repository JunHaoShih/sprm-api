...
namespace SprmApi.Migrations
{
    ...
    [Migration("20230713093935_Add-Custom-Attribute-And-Attribute-Link-To-Default-Object-Types")]
    partial class AddCustomAttributeAndAttributeLinkToDefaultObjectTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SprmApi.Core.MakeTypes.MakeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(646),
                            CreateUser = "system",
                            ...
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(650),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(654),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "外包",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(655),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ObjectTypes.ObjectType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(704),
                            CreateUser = "system",
                            Name = "料件",
                            Number = "PartVersion",
                            Remarks = "料件",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(705),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(739),
                            CreateUser = "system",
                            Name = "料件使用關係",
                            Number = "PartUsage",
                            Remarks = "料件使用關係",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(740),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(742),
                            CreateUser = "system",
                            Name = "工藝路徑",
                            Number = "Routing",
                            Remarks = "工藝路徑",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(742),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(744),
                            CreateUser = "system",
                            Name = "工藝路徑版本",
                            Number = "RoutingVersion",
                            Remarks = "工藝路徑版本",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(744),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 5L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(746),
                            CreateUser = "system",
                            Name = "製程",
                            Number = "Process",
                            Remarks = "製程",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(746),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 6L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(748),
                            CreateUser = "system",
                            Name = "工藝路徑使用關係",
                            Number = "RoutingUsage",
                            Remarks = "工藝路徑使用關係",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(748),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 7L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(749),
                            CreateUser = "system",
                            Name = "自訂屬性",
                            Number = "CustomAttribute",
                            Remarks = "自訂屬性",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(750),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 8L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(752),
                            CreateUser = "system",
                            Name = "屬性連結",
                            Number = "AttributeLink",
                            Remarks = "屬性連結",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(752),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.ProcessTypes.ProcessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(676),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "加工製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(676),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(679),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "檢驗製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(679),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(681),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "組裝製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(681),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(682),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "運輸製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 7, 13, 9, 39, 35, 60, DateTimeKind.Utc).AddTicks(683),
                            UpdateUser = "system"
                        });
                });
