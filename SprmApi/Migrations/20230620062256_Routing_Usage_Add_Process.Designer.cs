            ...
            modelBuilder.Entity("SprmApi.Core.ObjectTypes.ObjectType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(677),
                            CreateUser = "system",
                            Name = "料件",
                            Number = "PartVersion",
                            Remarks = "料件",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(677),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(680),
                            CreateUser = "system",
                            Name = "料件使用關係",
                            Number = "PartUsage",
                            Remarks = "料件使用關係",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(681),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(682),
                            CreateUser = "system",
                            Name = "產品途程",
                            Number = "Routing",
                            Remarks = "產品途程",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(682),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(683),
                            CreateUser = "system",
                            Name = "產品途程版本",
                            Number = "RoutingVersion",
                            Remarks = "產品途程版本",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(683),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 5L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(684),
                            CreateUser = "system",
                            Name = "製程",
                            Number = "Process",
                            Remarks = "製程",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(685),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 6L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(686),
                            CreateUser = "system",
                            Name = "途程之製程",
                            Number = "RoutingProcess",
                            Remarks = "途程之製程",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(686),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.Processes.MakeTypes.MakeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(629),
                            CreateUser = "system",
                            ...
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(631),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(637),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "外包",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(638),
                            UpdateUser = "system"
                        });
                });
            ...
            modelBuilder.Entity("SprmApi.Core.Processes.ProcessTypes.ProcessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(656),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "加工製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(657),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(659),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "檢驗製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(659),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(660),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "組裝製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(660),
                            UpdateUser = "system"
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(661),
                            CreateUser = "system",
                            IsSystemDefault = true,
                            Languages = new Dictionary<string, string>(),
                            Name = "運輸製程",
                            ...
                            Remarks = "System default, do not modify it",
                            UpdateDate = new DateTime(2023, 6, 20, 6, 22, 56, 330, DateTimeKind.Utc).AddTicks(661),
                            UpdateUser = "system"
                        });
                });
